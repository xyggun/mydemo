...
public class HomeFragment extends Fragment
{
    ...
    public void changeContent(String targetUrl){
        Log.d("test", "home changeContent() view=" + view + " myWebView=" + myWebView);
    }
    ...
    private void initWebView(View view) {
        ...
        webseting.setAppCacheMaxSize(1024 * 1024 * 10); // 设置缓冲大小
        ...
        myWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                Log.d("test", "home onfinished() url=" + url);
            }
        ...
        myWebView.loadUrl(Constant.WebViewUrl.HOME);
    }
