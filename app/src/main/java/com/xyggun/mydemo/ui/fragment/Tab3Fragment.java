...
public class Tab3Fragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        Log.d("test", "Tab3Fragment onAttach()");
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.d("test", "Tab3Fragment onCreate()");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("test", "Tab3Fragment onCreateView() view=" + view);
        initWebView(view);
        return view;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Log.d("test", "Tab3Fragment onViewCreated()");
    }

    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        Log.d("test", "Tab3Fragment onActivityCreated()");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.d("test", "Tab3Fragment onStart()");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.d("test", "Tab3Fragment onResume()");
    }

    public void changeContent(String targetUrl){
        Log.d("test", "tab3 changeContent() view=" + view + " myWebView=" + myWebView);
    }
    ...
    private void initWebView(View view) {
        ...
        myWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                Log.d("test", "tab3 onfinished() url=" + url);
            }
        ...
        myWebView.loadUrl(Constant.WebViewUrl.TAB3);
    }
