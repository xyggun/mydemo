...
public class BreakPointContinueActivity extends BaseActivity implements Runnable {

    private static final String FOLDER_PATH = "/downLoadTool/";
    private Button mBtnStart;
    private Button mBtnPause;
    private Button mBtnResume;
    private String downloadUrl = "http://images.apple.com/cn/ipad-pro/images/overview/canvas_large_2x.jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_break_point_continue);
